...
const checkNumber = () => {
  if (Number(inputNumber.value) === randomNumber) {
    actualNumber.innerHTML = randomNumber;
    ...
    actualScore.innerHTML = Number(actualScore.innerHTML) - 1;
    displayMessage(
      Number(inputNumber.value) < randomNumber ? `Too low!` : `Too high!`
    );
  }
};
const tryAgain = () => {
